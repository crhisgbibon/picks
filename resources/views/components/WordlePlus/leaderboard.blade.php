    ...
    <div id="leaderboardCenterText">
      <div id="leaderBoardTitleDiv" class="leaderboardContentDiv">
          <button id="refreshLeaderboardButton">
            <img id="refreshLeaderboardIMG" class="chartCenterImg" src="{{ asset('storage/Assets/undoLight.svg') }}">
          </button>
          Leaderboard.
          <button id="closeLeaderboardButton">
            <img id="closeLeaderboardIMG" class="chartCenterImg" src="{{ asset('storage/Assets/closeLight.svg') }}">
          </button>
      </div>
