      ...
      <div class="chartContentDiv">
        ...
        <div class="chartTextRight">
          <button id="closeChartButton">
            <img id="chartClose" class="chartCenterImg" src="{{ asset('storage/Assets/closeLight.svg') }}">
          </button>
        </div>
      </div>
      <div class="chartContentDiv">
        ...
        <div class="chartTextRight">
          <button id="cleanChartButton">
            <img id="chartErase" class="chartCenterImg" src="{{ asset('storage/Assets/eraseLight.svg') }}">
          </button>
        </div>
      </div>
      <div class="chartContentDiv">
